...
class NumerosAleatoriosSheredPreferencesPage extends StatefulWidget {
  const NumerosAleatoriosSheredPreferencesPage({Key? key}) : super(key: key);

  @override
  State<NumerosAleatoriosSheredPreferencesPage> createState() => _NumerosAleatoriosSheredPreferencesState();
}

class _NumerosAleatoriosSheredPreferencesState extends State<NumerosAleatoriosSheredPreferencesPage> {
  int? numeroGerado;
  int? qntCliques;
