...
class AppStorageService {
  ...
  Future<void> setNumerosAleatoriosNumeroGerado(int value) async {
    await _setInt(STORAGE_CHAVES.CHAVE_NUMERO_ALEATORIO.toString(), value);
  }

  Future<int> getNumerosAleatoriosNumeroGerado() async{
    return _getInt(STORAGE_CHAVES.CHAVE_NUMERO_ALEATORIO.toString());
  }

  Future<void> setNumerosAleatoriosQntCliques(int value) async {
    await _setInt(STORAGE_CHAVES.CHAVE_QNT_CLIQUES.toString(), value);
  }

  Future<int> getNumerosAleatoriosQntCliques() async{
    return _getInt(STORAGE_CHAVES.CHAVE_QNT_CLIQUES.toString());
  }
 ...
 Future<void> setDadosCadastraisNome(String nome) async {
  ...
  Future<void> setDadosCadastraisNivelExperiencia(String nivel) async {
    await _setString(STORAGE_CHAVES.CHAVE_DADOS_CADASTRAIS_NIVEL_EXPERIENCIA.toString(), nivel);
  }
  ...
  Future<void> setDadosCadastraisLinguages(List<String> linguagens) async {
